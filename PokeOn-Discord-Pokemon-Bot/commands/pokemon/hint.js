...
module.exports = {
    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {
        ...
        if (!spawn.pokemon[0]) return message.channel.send("> <:pokex:860541016230723594>  There is no pokemon here!");

        if (spawn.hcool) return message.channel.send("> <:pokex:860541016230723594> >>> You can't get a Hint right now!");
        ...
        return message.channel.send(`${done.join("")}`)
    }
}