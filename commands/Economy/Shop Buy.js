  ...
  execute: async (client, message, args, prefix, guild, color, channel) => {
    ...
    if (cmd == "1") {
      ...
      if (args[1].toLowerCase() == "candy") {
        ...
        if (amount >= 16) return message.channel.send("You cannot buy more than `15` candies at once!")
      ...
      if (args[1].toLowerCase() == "incense") {
        ...
        let msg = await message.channel.send("Please Confirm if you would like to buy `180` **Incense** for `1,000` **Shards**?")
        await msg.react("✅")
        msg.react("❌")
